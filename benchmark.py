...
parser.add_argument(
    "--dry-runs", type=int, default=2, help="Dry runs before measuring performance"
)
parser.add_argument(
    "--runs", type=int, default=5, help="How many benchmark runs to measure performance"
)
parser.add_argument(
    "--labels-path",
    default="labels.json",
...
parser.add_argument(
    "--rnn-type", default="gru", help="Type of the RNN. rnn|gru|lstm are supported"
)
...
parser.add_argument(
    "--num-samples", default=1024, type=int, help="Number of samples to go through"
)
parser.add_argument(
    "--mixed-precision",
    action="store_true",
